...
class CameraPosition {
  ...
  static CameraPosition? fromMap(Object? json) {
    ...
    return CameraPosition(
      ...
      miniSecond: json['miniSecond'] as int,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CameraPosition &&
        ...
        tilt == other.tilt &&
        zoom == other.zoom &&
        miniSecond == other.miniSecond;
  }

  @override
  int get hashCode => Object.hash(bearing, target, tilt, zoom,miniSecond);

  @override
  String toString() =>
      'CameraPosition(bearing: $bearing, target: $target, tilt: $tilt, zoom: $zoom, miniSecond: $miniSecond)';
}
